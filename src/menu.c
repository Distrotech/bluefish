...
static GtkItemFactoryEntry menu_items[] = {
	...
	{N_("/Edit/_Find..."), "<control>f", search_cb, 0, NULL},
	{N_("/Edit/Ne_w find..."), NULL, new_search_cb, 0, NULL},
	{N_("/Edit/Find agai_n"), "<control>g", search_again_cb, 0, NULL},
	{N_("/Edit/R_eplace..."), "<control>h", replace_cb, 0, NULL},
	{N_("/Edit/New re_place..."), NULL, new_replace_cb, 0, NULL},
	{N_("/Edit/Replace a_gain"), "<shift><control>h", replace_again_cb, 0, NULL},
	...
	{N_("/Edit/_Redo"), "<shift><control>z", redo_cb, 0, NULL},
	{N_("/Edit/Undo all"), NULL, undo_all_cb, 0, NULL},
	{N_("/Edit/Redo all"), NULL, redo_all_cb, 0, NULL},
	{N_("/Edit/sep5"), NULL, NULL, 0, "<Separator>"},
	{N_("/Edit/Block operations"), NULL, NULL, 0, "<Branch>"},
	{N_("/Edit/Block operations/Tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/Edit/Block operations/Indent block"), "<shift><control>i", menu_indent_cb, 0, NULL},
	{N_("/Edit/Block operations/Unindent block"), "<shift><control>u", menu_indent_cb, 1, NULL},
	{N_("/Edit/sep6"), NULL, NULL, 0, "<Separator>"},
	{N_("/Edit/_Goto line"), "<control>l", go_to_line_win_cb, 0, NULL},
...
/*	{N_("/Dialogs/General/DTD"), NULL, dtd_cb, 0, NULL},
	...
	{N_("/Dialogs/General/_Email..."), "<shift><alt>h", email_cb, 0, NULL},

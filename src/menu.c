...
/*	{N_("/Dialogs/Javascript"), NULL, NULL, 0, "<Branch>"},
	...
	{N_("/Project/_New Project"), NULL, project_menu_cb, 7, "<Item>"},
	...
	{N_("/Project/C_lose"), NULL, project_menu_cb, 4, "<Item>"},
	{N_("/Project/Save & _close"), NULL, project_menu_cb, 5, "<Item>"},
	{"/Project/sep2", NULL, NULL, 0, "<Separator>"},
	{N_("/Project/E_dit Project Options..."), NULL, project_menu_cb, 6, "<StockItem>", GTK_STOCK_PREFERENCES},

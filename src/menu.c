...
static GtkItemFactoryEntry menu_items[] = {
	...
	{N_("/Edit/S_hift Right"), NULL, menu_indent_cb, 2, "<Item>"},
	{N_("/Edit/Shift _Left"), NULL, menu_indent_cb, 1, "<Item>"},
...
/*	{N_("/Tags/Repeat last"), "F4", repeat_last_insert_cb, 0, NULL},*/
	...
	{N_("/Tags/Format general/<separator>"), NULL, NULL, 0, "<Separator>"},
	{N_("/Tags/Format general/_Center"), NULL, general_html_menu_cb, 8, "<Item>"},
	...
	{N_("/Tags/List/Unordered _List"), "<control><alt>L", general_html_menu_cb, 33, "<Item>"},
	{N_("/Tags/List/_Ordered List"), "<control><alt>O", general_html_menu_cb, 34, "<Item>"},
	{N_("/Tags/List/List Ite_m"), "<control><alt>M", general_html_menu_cb, 35, "<Item>"},
	{N_("/Tags/List/De_finition List"), NULL, general_html_menu_cb, 36, "<Item>"},
	{N_("/Tags/List/Definition _Term"), NULL, general_html_menu_cb, 37, "<Item>"},
	{N_("/Tags/List/_Definition"), NULL, general_html_menu_cb, 38, "<Item>"},
	{N_("/Tags/List/Men_u"), NULL, general_html_menu_cb, 39, "<Item>"},
	{N_("/Tags/Insert Generator _META-Tag"), NULL, general_html_menu_cb, 47, "<Item>"},
	{N_("/Tags/_Comment"), "<control><alt>C", general_html_menu_cb, 10, "<Item>"},
...
/*	{N_("/Dialogs/General/DTD"), NULL, dtd_cb, 0, NULL},
	...
	{N_("/Dialogs/CSS/_Div..."), "<shift><alt>D", menu_html_dialogs_lcb, 18, "<Item>"},

...
static const GtkActionEntry global_actions[] = {
	...
	{"DocFontSizeIncrease", NULL, N_("_Increase"), "<control>=", N_("Increase document font size"),
	 G_CALLBACK(ui_font_size_increase)},
	{"DocFontSizeDecrease", NULL, N_("_Decrease"), "<control>-", N_("Decrease document font size"),

...
/*	{N_("/Tags/Repeat last"), "F4", repeat_last_insert_cb, 0, NULL},*/
	...
	{N_("/Tags/Form/_Form"), NULL, general_html_menu_cb, 67, "<Item>"},
...
/*	{N_("/Tags/Form/"), NULL, general_html_menu_cb, , "<Item>"},*/
	...
	{N_("/Tags/Misc/_Anchor"), NULL, general_html_menu_cb, 63, "<Item>"},
	{N_("/Tags/Misc/_Image"), NULL, general_html_menu_cb, 64, "<Item>"},

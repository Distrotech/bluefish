...
static GtkItemFactoryEntry menu_items[] = {
	...
	{N_("/File/Sa_ve All"), NULL, menu_file_operations_cb, 8, "<Item>"},
	...
	{N_("/File/_Rename..."), "F2", menu_file_operations_cb, 7, "<Item>"},
	...
	{N_("/Edit/Goto _Line"), "<control>l", go_to_line_win_cb, 1, "<StockItem>", GTK_STOCK_JUMP_TO},
	{N_("/Edit/G_oto Selection"), NULL, go_to_line_from_selection_cb, 1, "<Item>"},
	{N_("/Edit/sep5"), NULL, NULL, 0, "<Separator>"},
	{N_("/Edit/_Preferences"), NULL, open_preferences_menu_cb, 0, "<StockItem>", GTK_STOCK_PREFERENCES},
	{N_("/_View"), NULL, NULL, 0, "<Branch>"},
	{N_("/View/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/View/_Toolbars"), NULL, NULL, 0, "<Branch>"},
	{N_("/View/Toolbars/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/View/Toolbars/View _Main Toolbar"), NULL, gui_toggle_hidewidget_cb, 1, "<ToggleItem>"},
	{N_("/View/Toolbars/View _HTML Toolbar"), NULL, gui_toggle_hidewidget_cb, 2, "<ToggleItem>"},
	{N_("/View/Toolbars/View _Custom Menu"), NULL, gui_toggle_hidewidget_cb, 3, "<ToggleItem>"},
	{N_("/View/Toolbars/View _Left Panel"), NULL, gui_toggle_hidewidget_cb, 4, "<ToggleItem>"},
	{N_("/View/_Current Document"), NULL, NULL, 0, "<Branch>"},
	{N_("/View/Current Document/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/View/Current Document/_Increase Tabsize"), NULL, gui_change_tabsize, 1, "<Item>"},
	{N_("/View/Current Document/_Decrease Tabsize"), NULL, gui_change_tabsize, 0, "<Item>"},
	{N_("/View/Current Document/sep1"), NULL, NULL, 0, "<Separator>"},
	{N_("/View/Current Document/_Auto Indent"), NULL, gui_toggle_autoindent_cb, 0, "<ToggleItem>"},
	{N_("/View/Current Document/_Wrap"), NULL, doc_toggle_wrap_cb, 1, "<ToggleItem>"},
	{N_("/View/Current Document/_Line Numbers"), NULL, doc_toggle_linenumbers_cb, 1, "<ToggleItem>"},
	{N_("/View/Current Document/sep2"), NULL, NULL, 0, "<Separator>"},
	{N_("/View/Current Document/_Highlight Syntax"), NULL, doc_toggle_highlighting_cb, 1, "<ToggleItem>"},
	{N_("/View/Current Document/_Update Highlighting"), "F5", doc_update_highlighting, 0, "<Item>"},
	{N_("/View/Current Document/sep3"), NULL, NULL, 0, "<Separator>"},
	{N_("/View/Current Document/Word _Count"), NULL, word_count_cb, 1, "<Item>"},
	{N_("/View/Current Document/Floating window"), NULL, file_floatingview_menu_cb, 1, "<Item>"},
	{N_("/View/Current Document _Type"), NULL, NULL, 0, "<Branch>"},
	{N_("/View/Current Document Type/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
...
/*	{N_("/Tags/Repeat last"), "F4", repeat_last_insert_cb, 0, NULL},*/
	...
	{N_("/Tags/Headings/H_1"), "<control><alt>1", general_html_menu_cb, 18, "<Item>"},
	{N_("/Tags/Headings/H_2"), "<control><alt>2", general_html_menu_cb, 19, "<Item>"},
	{N_("/Tags/Headings/H_3"), "<control><alt>3", general_html_menu_cb, 20, "<Item>"},
	{N_("/Tags/Headings/H_4"), "<control><alt>4", general_html_menu_cb, 21, "<Item>"},
	{N_("/Tags/Headings/H_5"), "<control><alt>5", general_html_menu_cb, 22, "<Item>"},
	{N_("/Tags/Headings/H_6"), "<control><alt>6", general_html_menu_cb, 23, "<Item>"},
	...
	{N_("/Tags/Format by layout/_Bold"), "<control><alt>b", general_html_menu_cb, 1, "<Item>"},
	{N_("/Tags/Format by layout/_Italic"), "<control><alt>i", general_html_menu_cb, 2, "<Item>"},
	{N_("/Tags/Format by layout/_Underline"), "<control><alt>u", general_html_menu_cb, 3, "<Item>"},
	...
	{N_("/Tags/Format by context/_Strong"), "<control><alt>g", general_html_menu_cb, 16, "<Item>"},
	{N_("/Tags/Format by context/_Emphasis"), "<control><alt>e", general_html_menu_cb, 17, "<Item>"},
	{N_("/Tags/Format by context/_Define"), NULL, general_html_menu_cb, 48, "<Item>"},
	{N_("/Tags/Format by context/_Code"), NULL, general_html_menu_cb, 49, "<Item>"},
	{N_("/Tags/Format by context/Sa_mple"), NULL, general_html_menu_cb, 50, "<Item>"},
	{N_("/Tags/Format by context/_Keyboard"), NULL, general_html_menu_cb, 51, "<Item>"},
	{N_("/Tags/Format by context/_Variable"), NULL, general_html_menu_cb, 52, "<Item>"},
	{N_("/Tags/Format by context/Ci_tation"), NULL, general_html_menu_cb, 53, "<Item>"},
	{N_("/Tags/Format by context/_Abbreviation"), NULL, general_html_menu_cb, 54, "<Item>"},
	{N_("/Tags/Format by context/Ac_ronym"), NULL, general_html_menu_cb, 55, "<Item>"},
	{N_("/Tags/Format _general"), NULL, NULL, 0, "<Branch>"},
	{N_("/Tags/Format general/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/Tags/Format general/_Paragraph"), "<control><alt>p", general_html_menu_cb, 5, "<Item>"},
	{N_("/Tags/Format general/_Break"),  "<control><alt>k", general_html_menu_cb, 6, "<Item>"},
	{N_("/Tags/Format general/Break clear _all"), NULL, general_html_menu_cb, 41, "<Item>"},
	{N_("/Tags/Format general/_Non-Breaking Space"), "<control><alt>n", general_html_menu_cb, 7, "<Item>"},
	{N_("/Tags/Format general/<separator>"), NULL, NULL, 0, "<Separator>"},
	{N_("/Tags/Format general/Font Si_ze +1"), "<control><alt>equal", general_html_menu_cb, 11, "<Item>"},
	{N_("/Tags/Format general/Font _Size -1"), "<control><alt>minus", general_html_menu_cb, 12, "<Item>"},
	{N_("/Tags/Format general/<separator>"), NULL, NULL, 0, "<Separator>"},
	{N_("/Tags/Format general/Preformatted _Text"), "<Control><Alt>f", general_html_menu_cb, 13, "<Item>"},
	{N_("/Tags/Format general/Su_bscript"), NULL, general_html_menu_cb, 14, "<Item>"},
	{N_("/Tags/Format general/Su_perscript"), NULL, general_html_menu_cb, 15, "<Item>"},
	{N_("/Tags/Format general/<separator>"), NULL, NULL, 0, "<Separator>"},
	{N_("/Tags/Format general/_Center"), "<control><alt>c", general_html_menu_cb, 8, "<Item>"},
	{N_("/Tags/Format general/Align _right"), "<control><Alt>r", general_html_menu_cb, 9, "<Item>"},
	{N_("/Tags/_Table"), NULL, NULL, 0, "<Branch>"},
	{N_("/Tags/Table/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/Tags/Table/_Table"), "<control><alt>t", general_html_menu_cb, 24, "<Item>"},
	{N_("/Tags/Table/Table _Row"), NULL, general_html_menu_cb, 25, "<Item>"},
	{N_("/Tags/Table/Table _Header"), NULL, general_html_menu_cb, 26, "<Item>"},
	{N_("/Tags/Table/Table _Data"), NULL, general_html_menu_cb, 27, "<Item>"},
	{N_("/Tags/Table/Table _Caption"), NULL, general_html_menu_cb, 28, "<Item>"},
	{N_("/Tags/_List"), NULL, NULL, 0, "<Branch>"},
	{N_("/Tags/List/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/Tags/List/_Unordered List"), "<control><alt>L", general_html_menu_cb, 33, "<Item>"},
	{N_("/Tags/List/_Ordered List"), "<control><alt>O", general_html_menu_cb, 34, "<Item>"},
	{N_("/Tags/List/List _Item"), NULL, general_html_menu_cb, 35, "<Item>"},
	{N_("/Tags/List/Definition _List"), NULL, general_html_menu_cb, 36, "<Item>"},
	{N_("/Tags/List/Definition _Term"), NULL, general_html_menu_cb, 37, "<Item>"},
	{N_("/Tags/List/De_finition"), NULL, general_html_menu_cb, 38, "<Item>"},
	{N_("/Tags/List/_Menu"), NULL, general_html_menu_cb, 39, "<Item>"},
	{N_("/Tags/Insert Generator _META-Tag"), NULL, general_html_menu_cb, 47, "<Item>"},
	{N_("/Tags/_Comment"), NULL, general_html_menu_cb, 10, "<Item>"},
	...
	{N_("/Dialogs/General/_Quickstart..."), "<shift><alt>q", menu_html_dialogs_lcb, 32, "<Item>"},
/*	{N_("/Dialogs/General/DTD"), NULL, dtd_cb, 0, NULL},
	{N_("/Dialogs/General/Head"), NULL, head_cb, 0, NULL}, */
	{N_("/Dialogs/General/_Body..."), "<shift><alt>B", menu_html_dialogs_lcb, 1, "<Item>"},
	{N_("/Dialogs/General/_Anchor..."), "<shift><alt>a", menu_html_dialogs_lcb, 2, "<Item>"},
	{N_("/Dialogs/General/_Email..."), "<shift><alt>e", menu_html_dialogs_lcb, 3, "<Item>"},
	{N_("/Dialogs/General/_Rule..."), "<shift><alt>r", menu_html_dialogs_lcb, 4, "<Item>"},
	...
	{N_("/Dialogs/General/Quick_list..."), "<shift><alt>L", menu_html_dialogs_lcb, 7, "<Item>"},
	{N_("/Dialogs/General/_Meta..."), "<shift><alt>m", menu_html_dialogs_lcb, 8, "<Item>"},
	{N_("/Dialogs/General/Embe_d..."), "<shift><alt>d", menu_html_dialogs_lcb, 9, "<Item>"},
	...
	{N_("/Dialogs/General/Insert _Image..."), "<shift><alt>I", menu_html_dialogs_lcb, 10, "<Item>"},
	{N_("/Dialogs/General/Insert T_humbnail..."), "<shift><alt>N", menu_html_dialogs_lcb, 11, "<Item>"},
	{N_("/Dialogs/_Table"), NULL, NULL, 0, "<Branch>"},
	{N_("/Dialogs/Table/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/Dialogs/Table/Table _Wizard..."), NULL, menu_html_dialogs_lcb, 12, "<Item>"},
	{N_("/Dialogs/Table/_Table..."), "<shift><alt>T", menu_html_dialogs_lcb, 13, "<Item>"},
	{N_("/Dialogs/Table/Table _Row..."), NULL, menu_html_dialogs_lcb, 14, "<Item>"},
	{N_("/Dialogs/Table/Table _Head..."), NULL, menu_html_dialogs_lcb, 15, "<Item>"},
	{N_("/Dialogs/Table/Table _Data..."), NULL, menu_html_dialogs_lcb, 16, "<Item>"},
	{N_("/Dialogs/_CSS"), NULL, NULL, 0, "<Branch>"},
	{N_("/Dialogs/CSS/tearoff1"), NULL, NULL, 0, "<Tearoff>"},
	{N_("/Dialogs/CSS/_Create Style..."), "<shift><alt>S", menu_html_dialogs_lcb, 36, "<Item>"},
	{N_("/Dialogs/CSS/S_pan..."), NULL, menu_html_dialogs_lcb, 17, "<Item>"},
	{N_("/Dialogs/CSS/_Div..."), NULL, menu_html_dialogs_lcb, 18, "<Item>"},
	{N_("/Dialogs/CSS/_Style..."), NULL, general_html_menu_cb, 42, "<Item>"},
	...
	{N_("/Dialogs/Frame/Frame _Wizard..."), NULL, menu_html_dialogs_lcb, 19, "<Item>"},
	{N_("/Dialogs/Frame/Frame_set..."), NULL, menu_html_dialogs_lcb, 20, "<Item>"},
	{N_("/Dialogs/Frame/_Frame..."), NULL, menu_html_dialogs_lcb, 21, "<Item>"},
...
/*	{N_("/Dialogs/Javascript"), NULL, NULL, 0, "<Branch>"},
	...
	{N_("/Project/_Save"), NULL, project_menu_cb, 2, "<StockItem>", GTK_STOCK_SAVE},
	{N_("/Project/Save _as..."), NULL, project_menu_cb, 3, "<StockItem>", GTK_STOCK_SAVE_AS},
	{N_("/Project/_Close & save"), NULL, project_menu_cb, 4, "<Item>"},
	{N_("/Project/sep2"), NULL, NULL, 0, "<Separator>"},
	{N_("/Project/_Edit Project Options..."), NULL, project_menu_cb, 5, "<StockItem>", GTK_STOCK_PREFERENCES},	
...
/*	{N_("/External/_Commands"), NULL, NULL, 0, "<Branch>"},
	...
	{N_("/Windows/New Bluefish Window"), NULL, gui_window_menu_cb, 1, "<Item>"},
	{N_("/Windows/Close"), NULL, gui_window_menu_cb, 2, "<Item>"},
...
void filetype_menu_rebuild(Tbfwin *bfwin,GtkItemFactory *item_factory) {
	...
	parent_menu = gtk_item_factory_get_widget(item_factory, N_("/View/Current Document Type"));
	while (tmplist) {
...
void menu_create_main(Tbfwin *bfwin, GtkWidget *vbox) {
	...
	setup_toggle_item(item_factory, N_("/View/Toolbars/View HTML Toolbar"), main_v->props.view_html_toolbar);
	setup_toggle_item(item_factory, N_("/View/Toolbars/View Custom Menu"), main_v->props.view_custom_menu);
	setup_toggle_item(item_factory, N_("/View/Toolbars/View Left Panel"), main_v->props.view_left_panel);
	setup_toggle_item(item_factory, N_("/View/Current Document/Auto Indent"), main_v->props.autoindent);
...
void encoding_menu_rebuild(Tbfwin *bfwin) {
	...
	parent_menu = gtk_item_factory_get_widget(gtk_item_factory_from_widget(bfwin->menubar), N_("/View/Current Document Encoding"));
	while (tmplist) {
